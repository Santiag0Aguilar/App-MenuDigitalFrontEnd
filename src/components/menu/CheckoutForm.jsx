...
const CheckoutForm = ({ businessPhone, businessSlug }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(validationErrors).length > 0) {
      if (validationErrors.customerName) setStep(1);
      else if (validationErrors.address || validationErrors.receiverName)
        setStep(2);
      else if (validationErrors.cashAmount) setStep(3);
  ...
  return (
    <form onSubmit={handleSubmit} className="checkout-form">
      ...
      <div className="progress-container">
        <div className="progress-text">Paso {step} de 4</div>
